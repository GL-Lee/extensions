...
var MenuEdit = {
  ...
  openSettings: function() {
  	autoShowMenu.OpenedPopup = null;
  	window.openDialog("chrome://automenu_GL/content/menueditprefs.xul",null ,"modal" ,document.getElementById("popupsBox"));
  },
  ...
  */
  ...
  moveToHbox: function(){
  	...
  	var panels = document.getElementById("popupsBox").children;
    var panel;
    var hbox;
    /*
    	...
    	if(panels[i].localName=='panel'){
	      ...
	      for(var j = 0, len2 = items.length; j < len2; j++){
	        ...
	        for(var l = 0; l < words.length; l++){
	        	items[0].label+=words[l].substring(0,1);
	        }
	      	hbox.appendChild(items[0]);
	      }
      	}
    }
    */
...
window.addEventListener("load",
  function() {
    ...
    //alert("ddddddddddd");
    setTimeout(function() {  MenuEdit.moveToHbox();}, 2000);
