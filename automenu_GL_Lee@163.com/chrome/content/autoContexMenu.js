var autoShowMenu = {
    	...
    	*/
    	...
    	//if(event.target == autoShowMenu.tipBox){
    		...
    		autoShowMenu.timerId = setTimeout(function(){
    			clearTimeout(autoShowMenu.timerId);
    			autoShowMenu.showPopup();
    			//autoShowMenu.tipBox.style.visibility='hidden';
    			},
    		400);
    	//	return;
    	//}
    ...
    showPopup: function(){
    	autoShowMenu.OpenedPopup && autoShowMenu.OpenedPopup.hidePopup();
		...
		if(popup){
    		...
    		var h = parseInt(window.getComputedStyle(popup, null).getPropertyValue('height'));
			popup.openPopupAtScreen(autoShowMenu.nowPoint.x +10 ,autoShowMenu.nowPoint.y - h - 15);
		}
    },
...
window.addEventListener("load", function(){
	...
	window.addEventListener("mousemove",
		function(){
			...
			autoShowMenu.nowPoint.x = arguments[0].screenX;
			autoShowMenu.nowPoint.y = arguments[0].screenY;
